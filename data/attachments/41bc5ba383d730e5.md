...
- Name: Assertions.spec.ts >> Comprehensive Playwright Assertions Examples >> toHaveAttribute() - Element has specific attribute
- Location: e2e/tests/Assertions.spec.ts:49:7
...
Call log:
  ...
  - waiting for getByPlaceholder('Username')
    14 × locator resolved to <input autofocus="" name="username" data-v-1f99f73c="" placeholder="Username" class="oxd-input oxd-input--focus"/>
